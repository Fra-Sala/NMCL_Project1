...
[h3, m3, ~, xvec3] = conservative_scheme(xspan, tspan, 400, 800, h0, m0, @lax_friedrichs_flux, @flux_phys, S, bc);
[h4, m4, ~, xvec4] = conservative_scheme(xspan, tspan, 800, 1600, h0, m0, @lax_friedrichs_flux, @flux_phys, S, bc);
[h5, m5, ~, xvec5] = conservative_scheme(xspan, tspan, 1500, 3000, h0, m0, @lax_friedrichs_flux, @flux_phys, S, bc);
...
legend('Ref: $N = 3000$', '$N = 100$', '$N = 250$', '$N = 400$', '$N = 800$', '$N = 1500$', 'Interpreter', 'latex', 'Location', 'best')
xlabel('$x$', 'Interpreter', 'latex')
ylabel('$h(x, t)$', 'Interpreter', 'latex')
grid on
xlim([0 2]);
...
% decreasing mesh sizes
[h1, m1, ~, xvec1] = conservative_scheme(xspan, tspan, 100, 200, h0, m0, @lax_wendroff_flux, @flux_phys, S, bc);
[h2, m2, ~, xvec2] = conservative_scheme(xspan, tspan, 250, 500, h0, m0, @lax_wendroff_flux, @flux_phys, S, bc);
[h3, m3, ~, xvec3] = conservative_scheme(xspan, tspan, 400, 800, h0, m0, @lax_wendroff_flux, @flux_phys, S, bc);
[h4, m4, ~, xvec4] = conservative_scheme(xspan, tspan, 800, 1600, h0, m0, @lax_wendroff_flux, @flux_phys, S, bc);
[h5, m5, ~, xvec5] = conservative_scheme(xspan, tspan, 1500, 3000, h0, m0, @lax_wendroff_flux, @flux_phys, S, bc);
...
legend('Lax-Wendroff', 'Lax-Friedrichs', 'Interpreter', 'latex', 'Location', 'best')
xlabel('$x$', 'Interpreter', 'latex')
ylabel('$h(x, t)$', 'Interpreter', 'latex')
grid on
xlim([0 2]);
